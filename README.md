...
4. Добавить класс Session для временного сохранения информации (когда пользователя меняет расписание).


6 Задача:
Цель: сделать интерфейс пользователя удобнее

1. Реализовать команду для добавления домашних заданий.
